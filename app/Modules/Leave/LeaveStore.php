...
class LeaveStore
{
    ...
    private function approvalMailHtml(array $request, string $stage, string $approveUrl, string $rejectUrl): string
    {
        ...
        return '<!doctype html><html><head><meta charset="utf-8"></head>'
            ...
            . '<div style="font-size:12px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;">Takii Intranet</div>'
            ...
            . '</tr></table>'
            . '<p style="margin:12px 0 0;font-size:12px;line-height:1.5;color:#66716a;">HTML desteklemeyen e-posta uygulamalarinda Takii Intranet uzerinden panel onayi kullanabilirsiniz.</p>'
            . '</td></tr></table>'
